...
from scraping.fetch_treasury import extract_page_rows


def extract_treasury_log(browser):
    existing_keys, all_rows = load_existing_rows()
    ...
    while True:
        ...
        rows = extract_page_rows(page.content())
        if not rows:
            break
